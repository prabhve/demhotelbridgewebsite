              ...
              <div className="space-y-8 animate-fadeIn max-w-5xl">
                ...
                <div className="p-6 rounded-2xl bg-[#161B22] border border-stone-800 space-y-5">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-stone-800/80 pb-4">
                    ...
                    <div className="flex items-center gap-1.5 p-1 rounded-xl bg-[#0D1117] border border-stone-800 text-xs">
                      <button
                        type="button"
                        onClick={() => {
                          setSeoPreviewMode('desktop');
                          showToast('Switched to Google Desktop SERP view');
                        }}
                      ...
                      <button
                        type="button"
                        onClick={() => {
                          setSeoPreviewMode('mobile');
                          showToast('Switched to Google Mobile SERP view');
                        }}
                        className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg transition-all cursor-pointer ${
                  ...
                  <div className="flex items-center justify-between px-3 py-2 rounded-xl bg-[#0D1117] border border-stone-800 text-xs text-stone-400">
                    <div className="flex items-center gap-2">
                      {seoPreviewMode === 'desktop' ? (
                        <>
                          <Monitor className="w-4 h-4 text-[#E5B869]" />
                          <span>Google Desktop Search Result Preview (Standard 652px desktop column)</span>
                        </>
                      ) : (
                        <>
                          <Smartphone className="w-4 h-4 text-[#E5B869]" />
                          <span>Google Mobile Search Result Preview (Simulated 375px Smartphone Viewport)</span>
                        </>
                      )}
                    </div>
                    <span className="font-mono text-[10px] text-stone-500 uppercase tracking-wider">
                      {seoPreviewMode === 'desktop' ? 'Desktop SERP' : 'Mobile SERP'}
                    </span>
                  </div>
                  ...
                  {seoPreviewMode === 'desktop' && (
                    <div className="space-y-3">
                      <div className="max-w-[680px] p-5 rounded-2xl bg-[#202124] border border-stone-700/80 font-sans shadow-xl text-left space-y-3">
                        {/* Desktop Search Bar Mockup */}
                        <div className="flex items-center justify-between px-3.5 py-2 rounded-full bg-[#303134] border border-[#5f6368]/50 text-xs text-stone-300">
                          <div className="flex items-center gap-2.5">
                            <Search className="w-3.5 h-3.5 text-stone-400" />
                            <span className="text-white font-medium">hotel bridge unnao</span>
                          </div>
                        ...
                        <div className="pt-2">
                          <div className="flex items-center gap-2.5 mb-1.5">
                            <div className="w-7 h-7 rounded-full bg-[#303134] flex items-center justify-center overflow-hidden shrink-0 border border-stone-600 shadow-xs">
                              <img src="/logo.svg" alt="Google Favicon" className="w-4 h-4 object-contain" />
                            </div>
                            <div className="flex flex-col">
                              <div className="flex items-center gap-1.5">
                                <span className="text-[13px] text-[#bdc1c6] font-medium leading-none">
                                  Hotel Bridge, Unnao
                                </span>
                                <span className="text-[10px] text-stone-500">•</span>
                                <span className="text-[11px] text-[#9aa0a6] leading-none">hotelbridge.in</span>
                              </div>
                              <span className="text-[11px] text-[#9aa0a6] leading-none mt-1 truncate">
                                {formData.seo?.canonicalUrl || formData.website || 'https://hotelbridge.in'} › unnao › hotel-rooms
                              </span>
                            </div>
                            <MoreVertical className="w-4 h-4 text-stone-500 ml-auto shrink-0" />
                          </div>

                          {/* Desktop SERP Title */}
                          <h4 className="text-lg sm:text-xl text-[#8ab4f8] font-normal hover:underline cursor-pointer leading-snug line-clamp-1">
                          ...
                          <div className="flex items-center gap-2 text-xs text-stone-300 my-1">
                            ...
                            <span className="font-semibold text-white">Rating: 4.6</span>
                            <span className="text-stone-400">· 140+ reviews · 3-star hotel</span>
                          </div>

                          {/* Desktop Meta Description Snippet */}
                          ...
                          {/* Desktop Sitelinks Grid */}
                          <div className="mt-4 pt-3 border-t border-stone-700/60 grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                            <div className="space-y-0.5">
                              <div className="text-[#8ab4f8] hover:underline cursor-pointer font-medium">
                                Rooms &amp; Suites
                              </div>
                              <p className="text-[11px] text-[#9aa0a6] line-clamp-1">
                                Premium AC rooms, bridal suites &amp; executive stays.
                              </p>
                            </div>
                            <div className="space-y-0.5">
                              <div className="text-[#8ab4f8] hover:underline cursor-pointer font-medium">
                                Royal Kitchen Pure Veg
                              </div>
                              <p className="text-[11px] text-[#9aa0a6] line-clamp-1">
                                North Indian delicacies, tandoor &amp; Jain food menu.
                              </p>
                            </div>
                            <div className="space-y-0.5">
                              <div className="text-[#8ab4f8] hover:underline cursor-pointer font-medium">
                              ...
                              <p className="text-[11px] text-[#9aa0a6] line-clamp-1">
                                Host weddings, ring ceremonies &amp; conferences.
                              </p>
                            </div>
                            <div className="space-y-0.5">
                              <div className="text-[#8ab4f8] hover:underline cursor-pointer font-medium">
                                Contact &amp; Bypass Location
                              </div>
                              <p className="text-[11px] text-[#9aa0a6] line-clamp-1">
                                595 Pitamber Nagar-II, Unnao bypass. 24/7 desk.
                              </p>
                            </div>
                          </div>
                        </div>
                  ...
                  {/* =========================================================================
                      MOBILE GOOGLE SERP PREVIEW (Simulated Smartphone)
                     ========================================================================= */}
                  {seoPreviewMode === 'mobile' && (
                    <div className="flex justify-center py-2">
                      <div className="w-full max-w-[390px] rounded-[36px] bg-[#101216] border-[4px] border-stone-700 p-3 shadow-2xl relative overflow-hidden font-sans">
                        {/* Smartphone Speaker & Camera Notch */}
                        <div className="flex items-center justify-between px-4 pt-1 pb-2 text-[11px] text-stone-400 font-mono">
                          <span>9:41</span>
                          <div className="w-18 h-3.5 bg-black rounded-full border border-stone-800" />
                          <div className="flex items-center gap-1.5">
                        ...
                        {/* Mobile Google Search Bar */}
                        <div className="my-2 px-3 py-2 rounded-full bg-[#202124] border border-stone-700 flex items-center justify-between text-xs text-stone-300 shadow-xs">
                          <div className="flex items-center gap-2">
                            <span className="font-bold text-white text-xs">G</span>
                            <span className="text-stone-300 text-xs truncate">hotel bridge unnao</span>
                          </div>
                          <Search className="w-3.5 h-3.5 text-stone-400" />
                        </div>

                        {/* Mobile SERP Card */}
                        <div className="rounded-2xl bg-[#202124] border border-stone-700/80 p-3.5 space-y-2.5 mt-2">
                          {/* Site Identity */}
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              <div className="w-6 h-6 rounded-full bg-[#303134] flex items-center justify-center overflow-hidden shrink-0 border border-stone-600">
                                <img src="/logo.svg" alt="Favicon" className="w-3.5 h-3.5 object-contain" />
                              </div>
                              <div className="flex flex-col">
                                <span className="text-xs font-semibold text-white leading-tight">
                                  Hotel Bridge, Unnao
                                </span>
                                <span className="text-[10px] text-[#9aa0a6] leading-tight truncate">
                                  https://hotelbridge.in › unnao
                                </span>
                              </div>
                            </div>
                            <MoreVertical className="w-4 h-4 text-stone-500 shrink-0" />
                          </div>

                          {/* Mobile SERP Title */}
                          <h4 className="text-[15px] font-medium text-[#8ab4f8] leading-tight line-clamp-2 hover:underline cursor-pointer">
                            {formData.seo?.metaTitle || `${formData.name}, ${formData.city} | Best Hotel & Pure Veg Restaurant on Lucknow Bypass`}
                          </h4>
                          ...
                          <div className="flex items-center gap-2 text-[11px] text-stone-300 flex-wrap">
                            ...
                            <span className="text-stone-400">(140+)</span>
                            <span className="text-stone-600">•</span>
                            <span className="text-stone-300">3-star hotel</span>
                            <span className="text-stone-600">•</span>
                          ...
                          {/* Mobile Quick Action Buttons (Call / Directions / Website) */}
                          <div className="grid grid-cols-3 gap-1.5 pt-1">
                            <div className="flex flex-col items-center justify-center py-1.5 px-2 rounded-xl bg-[#303134] text-[10px] text-stone-200 border border-stone-700/60">
                              <Phone className="w-3 h-3 text-[#E5B869] mb-0.5" />
                              <span>Call</span>
                            </div>
                            <div className="flex flex-col items-center justify-center py-1.5 px-2 rounded-xl bg-[#303134] text-[10px] text-stone-200 border border-stone-700/60">
                              <Navigation className="w-3 h-3 text-[#E5B869] mb-0.5" />
                              <span>Directions</span>
                            </div>
                            <div className="flex flex-col items-center justify-center py-1.5 px-2 rounded-xl bg-[#303134] text-[10px] text-stone-200 border border-stone-700/60">
                              <Globe className="w-3 h-3 text-[#E5B869] mb-0.5" />
                              <span>Website</span>
                            </div>
                          </div>

                          {/* Mobile Sitelinks Horizontal Pills */}
                          <div className="pt-1.5 flex items-center gap-1.5 overflow-x-auto pb-1 text-[11px] custom-scrollbar">
                            <span className="px-2.5 py-1 rounded-full bg-[#303134] text-[#8ab4f8] whitespace-nowrap border border-stone-700/50">
                              Rooms &amp; Suites
                            </span>
                            <span className="px-2.5 py-1 rounded-full bg-[#303134] text-[#8ab4f8] whitespace-nowrap border border-stone-700/50">
                              Royal Kitchen Veg
                        ...
                        <div className="w-28 h-1 bg-stone-600 rounded-full mx-auto mt-3 mb-1" />
                      </div>
                    </div>
                  )}
